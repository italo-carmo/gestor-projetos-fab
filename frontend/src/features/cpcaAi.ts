...
export const CPCA_AI_QUICK_PROMPTS = [
  "Liste as principais inconsistências cadastrais e normativas nos reportes CPCA.",
  "Monte um briefing executivo dos reportes CPCA abertos, com prioridades por OM.",
  "Crie um relatório analítico dos reportes CPCA com base nos casos e nas bases de conhecimento selecionadas.",
  "Aponte gargalos de workflow e riscos institucionais nos reportes CPCA.",
] as const;
...
const FEATURE_LABELS: Record<AiProfileFeatureId, string> = {
  ...
  structured_complaints: "Perfis de reportes",
