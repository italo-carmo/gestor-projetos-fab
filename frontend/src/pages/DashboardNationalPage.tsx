        ...
        {[
          {
            ...
            bg: 'linear-gradient(145deg, #08495B 0%, #0C657E 52%, #3C91A8 100%)',
            border: '1px solid rgba(158, 216, 234, 0.44)',
            shadow: '0 18px 34px rgba(8,73,91,0.3)',
            titleColor: '#F4FAFD',
          ...
          },
          {
            ...
            bg: 'linear-gradient(145deg, #063D4E 0%, #0A5A71 46%, #2E84A0 100%)',
            border: '1px solid rgba(149, 209, 228, 0.42)',
            shadow: '0 18px 34px rgba(6,61,78,0.31)',
            titleColor: '#F2FBFE',
