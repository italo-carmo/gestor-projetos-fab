    ...
    <Stack spacing={2.5}>
      ...
      {ownCount === 0 && (
        <Alert severity="info">
          ...
          telas de reportes e indicadores CPCA não exibirão registros.
        </Alert>
      )}
      ...
      <ConfirmDialog
        ...
        message={
          confirmation?.action === "ASSIGN"
            ? "Os reportes dessas OMs passarão a compor o acompanhamento e os indicadores do seu ODGSA."
            : "As OMs ficarão sem ODGSA e seus reportes deixarão de aparecer no seu acompanhamento."
        }
