...
const ANALYSIS_CARDS: {
  ...
  },
  {
    ...
    title: "Visão Geral",
    description:
      "Leitura executiva dos indicadores-chave: pesquisas, reportes, atividades e missões.",
...
const CHATBOT_QUICK_PROMPTS = [
  ...
  "Explique a diferença entre reportes CPCA e reportes SMIF com base no sistema.",
