...
function formatDetachedOmSummary(payload: DeleteOmResponse | null | undefined) {
  ...
  const labels: Array<[number | undefined, string]> = [
    ...
    [detached.cpcaCases, "reportes CPCA"],
    ...
    <Box>
      ...
      {canDeleteOms ? (
        <ConfirmDialog
          ...
          title="Excluir OM"
          message="A OM será removida do catálogo, mas os registros relacionados serão preservados. Usuários, reportes e vínculos de comissão apenas perderão a associação com esta OM."
