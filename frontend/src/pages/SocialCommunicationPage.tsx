  ...
  const renderHighlightCarousel = (
    ...
    const theme =
      impact === "MULTIPLICADOR"
        ? {
            accent: "#2B78B8",
            accentSoft: "rgba(240, 248, 255, 0.14)",
            ...
            cardBackground: "rgb(76, 122, 150)",
            chipBorder: "rgba(236, 246, 255, 0.44)",
            chipColor: "#F4FAFF",
            impactChipBg: "rgba(236, 246, 255, 0.18)",
            impactChipColor: "#F4FAFF",
            actionButtonBg: "rgba(255,255,255,0.92)",
            hoverShadow: "0 14px 24px rgba(17, 66, 89, 0.16)",
          }
        : {
            accent: "#2E8B57",
            accentSoft: "rgba(241, 252, 246, 0.14)",
            ...
            cardBackground: "rgb(85, 140, 109)",
            chipBorder: "rgba(241, 252, 246, 0.44)",
            chipColor: "#F2FDF7",
            impactChipBg: "rgba(241, 252, 246, 0.18)",
            impactChipColor: "#F2FDF7",
            actionButtonBg: "rgba(255,255,255,0.92)",
            hoverShadow: "0 14px 24px rgba(17, 66, 89, 0.16)",
          };
    ...
    <Box>
      ...
      <Card
        sx={{
          ...
          backgroundColor: "rgb(217, 223, 230)",
