...
const library_uploads_controller_1 = require("./library-uploads.controller");
...
exports.LibraryModule = LibraryModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [library_controller_1.LibraryController, library_uploads_controller_1.LibraryUploadsController],
