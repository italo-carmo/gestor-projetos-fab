...
exports.getLibraryDocumentsDir = getLibraryDocumentsDir;
exports.resolveExistingLibraryDocumentPath = resolveExistingLibraryDocumentPath;
const fs = __importStar(require("node:fs"));
const path = __importStar(require("node:path"));
const persistentDocumentsDir = process.env.LIBRARY_DOCUMENTS_DIR?.trim() ||
