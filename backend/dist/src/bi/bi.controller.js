...
__decorate([
    ...
    __param(3, (0, common_1.Query)('om')),
    __param(4, (0, common_1.Query)('posto')),
    __param(5, (0, common_1.Query)('postoGraduacao')),
    __param(6, (0, common_1.Query)('autodeclara')),
    __param(7, (0, common_1.Query)('suffered')),
    __param(8, (0, common_1.Query)('violenceType')),
...
__decorate([
    ...
    __param(10, (0, common_1.Query)('combineMode')),
