...
const pin_notice_dto_1 = require("./dto/pin-notice.dto");
...
__decorate([
    (0, common_1.Get)(),
    (0, require_permission_decorator_1.RequirePermission)('notices', 'view'),
...
__decorate([
    (0, common_1.Post)(),
    (0, require_permission_decorator_1.RequirePermission)('notices', 'create'),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, require_permission_decorator_1.RequirePermission)('notices', 'update'),
...
__decorate([
    ...
    (0, require_permission_decorator_1.RequirePermission)('notices', 'delete'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, require_permission_decorator_1.RequirePermission)('notices', 'pin'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, pin_notice_dto_1.PinNoticeDto, Object]),
    __metadata("design:returntype", void 0)
