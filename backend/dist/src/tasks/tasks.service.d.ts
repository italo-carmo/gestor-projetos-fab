...
export declare class TasksService {
    ...
    updateDashboardNationalCardSetting(id: string, payload: {
        title?: string;
        description?: string;
        backgroundColor?: string;
        textColor?: string;
    ...
    private getActivitySpecialties;
    ...
    private getDashboardNationalCardSettings;
    private assertDashboardNationalCardManageAccess;
