/**
 * seed-demo.ts — Carrega sample_data/ no banco (Prisma)
 * Caminhos relativos à raiz do monorepo (../.. a partir de backend/scripts).
 */
...
const dataDir = path.join(rootDir, "docs", "sample_data");
...
async function main() {
  ...
  const eloRoleLabelByCode: Record<string, string> = {
