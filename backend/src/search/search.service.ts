...
const SEARCH_SCREEN_CANDIDATES: SearchScreenCandidate[] = [
  ...
  },
  {
    ...
    entityType: 'SCREEN',
    entityTypeLabel: 'Tela',
    path: '/cpca-cases?scope=SMIF',
    title: 'Reportes SMIF',
    subtitle: 'Fluxo de reportes do sistema SMIF',
    keywords: [
      'reporte',
      'reportes',
      'acolhimento',
  ...
  },
  {
    ...
    path: '/cpca-cases',
    title: 'Reportes CPCA',
    subtitle: 'Casos e andamento de reportes CPCA',
    keywords: [
      'cpca',
      'reporte',
      'reportes',
  ...
  },
  {
    ...
    subtitle: 'Painel de indicadores de reportes CPCA',
    keywords: [
      'cpca',
      'reporte',
      'reportes',
