...
const SEARCH_SCREEN_CANDIDATES: SearchScreenCandidate[] = [
  ...
  },
  {
    ...
    subtitle: 'Fluxo de acolhimentos do sistema SMIF',
    keywords: ['acolhimento', 'acolhimentos', 'denúncia', 'denuncias', 'smif', 'caso'],
  ...
  },
  {
    ...
    entityTypeLabel: 'Tela',
    path: '/cpca-cases',
    title: 'Acolhimentos CPCA',
    subtitle: 'Casos e andamento de acolhimentos CPCA',
    keywords: ['cpca', 'acolhimento', 'acolhimentos', 'denúncia', 'denuncias', 'caso cpca'],
  ...
  },
  {
    ...
    subtitle: 'Painel de indicadores de acolhimentos CPCA',
    keywords: ['cpca', 'acolhimento', 'acolhimentos', 'denúncia', 'denuncias', 'dashboard cpca'],
    isAllowed: (user) => hasPermission(user, 'cpca_cases', 'view'),
  },
];
